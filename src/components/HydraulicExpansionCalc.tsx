    ...
    >
      ...
      <div className="p-4 space-y-5">
        ...
        <div className="space-y-2">
          ...
          <SegmentedControl
            options={[
              { value: 'yes', label: 'Igen, HMV tárolóval' },
              { value: 'no',  label: 'Nincs HMV' },
            ]}
            value={hydraulicState.includeDhwTank ? 'yes' : 'no'}
            onChange={(v) => updateInput('includeDhwTank', v === 'yes')}
            layoutId="hydraulic-dhw"
        ...
        <hr className={`my-2 ${isDark ? 'border-slate-800' : 'border-slate-200'}`} />
          ...
          <div className={`p-3 rounded border space-y-4 ${isDark ? 'bg-slate-950/40 border-slate-800' : 'bg-slate-50 border-slate-200'}`}>
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="range"
                min={5} max={50} step={5}
                value={hydraulicState.pipeLengthEstimate ?? 15}
            ...
            <div className="space-y-1.5">
              ...
              <input
                type="range"
                min={2} max={20} step={1}
                value={hydraulicState.fittingsCount ?? 8}
