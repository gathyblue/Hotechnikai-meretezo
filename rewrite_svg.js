          ...
          >
            ...
            {hydraulicState.includeHeatExchanger ? (
              <>
                ...
                <rect x="350" y="320" width="60" height="80" rx="4" fill={isDark ? "#0f172a" : "#f1f5f9"} stroke="#f43f5e" strokeWidth="2" />
                <text x="380" y="360" fill={isDark ? "#cbd5e1" : "#475569"} fontSize="8" fontWeight="bold" textAnchor="middle">SOROS PUFFER</text>
              ...
              <>
                ...
                <text x="570" y="240" fill={isDark ? "#34d399" : "#059669"} fontSize="8" fontWeight="bold" textAnchor="middle">Szekunder Köri Szivattyú</text>
              </>
            )}
            ...
            {hydraulicState.includeHeatExchanger ? (
              <>
                ...
                <text x="300" y="415" fill="#ffffff" fontSize="7" fontWeight="bold" textAnchor="middle">Primer tág.</text>
                <text x="600" y="415" fill="#ffffff" fontSize="7" fontWeight="bold" textAnchor="middle">Szekunder tág.</text>
              </>
            ) : (
              <>
                <use href="#expansion-vessel" x="350" y="390" />
                <path d="M 350,340 V 360" fill="none" stroke="#3b82f6" strokeWidth="2" />
                <text x="350" y="415" fill="#ffffff" fontSize="7" fontWeight="bold" textAnchor="middle">Fűtési tág. ({hydraulicResults.vesselSizeL}L)</text>
              </>
            )}
            ...
            <g transform="translate(20, 190)">
              ...
              <text x="50" y="130" fill={isDark ? "#94a3b8" : "#475569"} fontSize="8" fontWeight="bold" textAnchor="middle">Monoblokk R290</text>
